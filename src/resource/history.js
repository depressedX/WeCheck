...
export function getUserHistory(group_id,username) {
    ...
    return server.get('group/'+group_id+'/user/'+username)
};
...
export function getGroupHistory(group_id) {
    ...
    return server.get('history/'+group_id)
}
...
export function getEveryoneHistory(groupid) {
    ...
    //         "done_percent":"90%"
    //     },];
    return server.get('group/'+groupid+"/user/record")
}
...
export function getRecord(recordId) {
    ...
    return server.get('record/'+recordId)
}
